...
```Uper tumne dekha ki cluster par access karne ke liye tumne Azure AD ke thorugh AKS ko access kiya, jo admin access ke liye hota hai. Lekin hum khud ka secret ya token create karke bhi cluster par access le sakte hain.```

Usi ke liye ye method hota hai **X.509 Client Certificates**.

X.509 Client Certificates ek method hota hai kubernetes cluster par access karne ke liye.
